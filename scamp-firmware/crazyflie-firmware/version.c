...
const char * V_SREVISION="21f031d0df70";
const char * V_STAG="2014.12.1";
const char * V_BRANCH="dev-buzzer";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x21f031d0;
const uint16_t V_REVISION_1=0xdf70;
