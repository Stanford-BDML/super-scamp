...
CFLAGS += -Wall -Wmissing-braces -fno-strict-aliasing $(C_PROFILE) -std=gnu11 -Wno-error=unused-function -Wno-error=comment -Wno-error=maybe-uninitialized -Wno-error=unused-variable
